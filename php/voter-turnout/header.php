<?php 
// Text to display
$id          = "voter-turnout-header";
$title       = "USG Elections";
$author_1    = "Christopher Go";
$author_2    = "Crysha Juliana Dela Pena";
$description = "Previous University Student Government elections had seen a significant 
                increase of voter population in both Manila and Laguna campuses, yet the 
                turnout percentages remain around or barely above the midpoint. In the 
