...
<!-- Bootstrap CSS -->
<!-- Uncomment the link tag below to use the CDN instead of the local ready-compiled stylesheet -->
...
<link href="https://fonts.googleapis.com/css2?family=EB+Garamond:ital,wght@0,400;0,700;1,400;1,700&family=Open+Sans:ital,wght@0,300;0,400;0,600;0,700;1,300;1,400;1,700&display=swap" rel="stylesheet">
