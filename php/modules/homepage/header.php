<div class="header-wrapper">
    <div id="about-the-cover">
        <div class="text-wrapper">
            ...
            <p class="mb-0">A communi observantia non est recedendum. Vivamus sagittis lacus vel augue laoreet rutrum faucibus. Nihilne te nocturnum praesidium Palati, nihil urbis vigiliae. Non equidem invideo, miror magis posuere velit aliquet. Quisque placerat facilisis egestas cillum dolore. Curabitur blandit tempus ardua ridiculus sed magna. Contra legem facit qui id facit quod lex prohibet. Petierunt uti sibi concilium totius Galliae in diem certam indicere.</p>
        </div>
        ...
        <div class="button-wrapper">
            <button onclick="hideAboutTheCover()" class="button button-white">Back</button>
        </div>
    </div>
    <header>
        <!-- Logo -->
