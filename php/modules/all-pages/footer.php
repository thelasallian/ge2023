    ...
    <div class="footer">
        <div class="container py-5 d-flex flex-column align-items-center mx-auto">
            ...
            <div class="py-3 row flex-wrap">
                <a type="button" class="custom-button button btn btn-outline-light mx-2 col">VISIT MAIN WEBSITE</a>
                <a type="button" class="custom-button button btn btn-outline-light mx-2 col">VIEW MAGAZINE</a>
            </div>
