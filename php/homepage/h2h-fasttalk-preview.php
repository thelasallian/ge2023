<section id="h2h-fastTalk">
    <div class="container">
        <div id="h2h" class="greenPreview">
            <div class="greenPreview-imgWrapper">
                <img src="assets/homepage/head-to-head.png" class="greenPreview-img">
            </div>
            <div class="greenPreview-info">
                ...
                <a href="/head-to-head" class="button button-white">View Articles</a>
        ...
        <div id="fast-talk" class="greenPreview">
            ...
            <div class="greenPreview-info">
                ...
                <a href="/fast-talk" class="button button-white">View Interactive</a>
                <!-- <a class="button button-white">Coming Soon</a> -->
            </div>
        </div>
    </div>
