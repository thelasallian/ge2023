...
<head>
    ...
    <!-- Title Meta -->
    <meta property="og:title" content="Head to Head - The LaSallian SE 2023 Special" />
    ...
    <!-- Document Title -->
    <title>Head to Head - The LaSallian SE 2023 Special</title>
</head>

<body>
    <!-- Header -->
    <?php include_once 'php/head-to-head/header.php'; ?>

    <!-- Grid -->
    <?php include_once 'php/head-to-head/grid.php'; ?>
